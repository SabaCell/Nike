...
namespace Nike.Redis
{
    ...
    {
        public static async Task<T> GetAsync<T>(this IDistributedCache source, string key, CancellationToken cancellationToken = default)
        {
        ...
        public static Task CreateEntryAsync(this IDistributedCache cache, string key, object value, CancellationToken cancellationToken = default)
        {
