...
public class KafkaConsumerBackgroundService : BackgroundService
{
    ...
    public KafkaConsumerBackgroundService(IKafkaConsumerConnection connection,
        IServiceProvider serviceProvider, ILogger<KafkaConsumerBackgroundService> logger)
    {
