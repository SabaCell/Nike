...
public class GetCustomerDetailsQuery : CachableQueryBase<GetCustomerDetailsQueryResult>
{
    ...
    {
        return $"{nameof(GetCustomerDetailsQuery)}_{CustomerId}";
    }
}
...
public class
    GetCustomerDetailsQueryHandler : CachableQueryEventHandler<GetCustomerDetailsQuery, GetCustomerDetailsQueryResult>
{
