...
namespace Nike.Api.Application.Customers.Query
{
    public class GetAllCustomersQuery : CachableQueryBase<IEnumerable<GetAllCustomersQueryResult>>
    {
        ...
        /// <inheritdoc />
        public override string GetKey() => $"{nameof(GetAllCustomersQuery)}_{PageIndex}_{PageSize}";
    }
    ...
    public class GetAllCustomersQueryHandler : CachableQueryEventHandler<GetAllCustomersQuery, IEnumerable<GetAllCustomersQueryResult>>
    {
